  ...
  return (
    <footer className="bg-black text-gray-400 py-16 px-5 lg:px-20 mt-20">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2 hover:text-white cursor-pointer">
              <div className="bg-white text-black rounded-full p-1"><FaTwitter size={12} /></div> Customer Support
            </li>
            <li className="flex items-center gap-2 hover:text-white cursor-pointer">
              <div className="bg-white text-black rounded-full p-1"><FaLinkedin size={12} /></div> Customer Support
            </li>
            <li className="flex items-center gap-2 hover:text-white cursor-pointer">
              <div className="bg-white text-black rounded-full p-1"><FaFacebook size={12} /></div> Customer Support
            </li>
            <li className="flex items-center gap-2 hover:text-white cursor-pointer">
              <div className="bg-white text-black rounded-full p-1"><MdEmail size={12} /></div> support@ticketmanage.com
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800 mt-16 pt-8 text-center text-xs">
        <p>© 2026 Customer Support. All rights reserved.</p>
      </div>
    </footer>
  );
};
